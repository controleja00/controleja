          ...
          {done ? (
            <div className="text-center py-4">
              <div className="h-14 w-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: "#8096bc" }}>
                <CheckCircle2 className="h-7 w-7" style={{ color: "#1f3258" }} />
              </div>
              <h2 className="text-xl font-black mb-2" style={{ color: "#172441" }}>Senha redefinida!</h2>
              <p className="text-sm mb-6" style={{ color: "#424c62" }}>Sua senha foi alterada com sucesso. Você já pode entrar com a nova senha.</p>
              <Link to="/login">
                <button className="w-full h-11 rounded-lg font-bold text-white" style={{ background: "#1f3258" }}>Ir para o login</button>
              </Link>
            </div>
          ) : (
            <>
              ...
              <Link to="/forgot-password" className="text-xs hover:underline flex items-center justify-center mt-4" style={{ color: "#778096" }}>
                Solicitar novo link
              </Link>
            </>
          )}
