        ...
        <div className="rounded-2xl p-7" style={{ background: "#FFFFFF", border: "1.5px solid #efefef" }}>
          {step === "form" ? (
            <>
              ...
              <button type="button" onClick={handleGoogleRegister} className="w-full h-11 rounded-lg font-medium text-sm flex items-center justify-center gap-2 transition-colors hover:bg-[#fbfaf8]" style={{ border: "1.5px solid #efefef", background: "#FFFFFF", color: "#111917" }}>
