  ...
  return (
    <div className="min-h-screen font-sans" style={{ background: "#F3F6F2" }}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="text-3xl font-black mb-8" style={{ color: "#111917" }}>Política de Privacidade</h1>
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: "#52615B" }}>
          ...
          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: "#111917" }}>3. Finalidade do tratamento</h2>
            <ul className="list-disc pl-5 space-y-1.5">
          ...
          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: "#111917" }}>4. Compartilhamento de dados</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: "#111917" }}>5. Seus direitos (LGPD)</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: "#111917" }}>6. Segurança</h2>
          ...
          <section>
            <h2 className="text-base font-bold mb-2" style={{ color: "#111917" }}>7. Retenção de dados</h2>
