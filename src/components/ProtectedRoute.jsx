...
const DefaultFallback = () => (
  <div className="fixed inset-0 flex flex-col items-center justify-center gap-3" style={{ background: "#fbfaf8" }}>
    <div className="h-10 w-10 rounded-2xl flex items-center justify-center" style={{ background: "#004038" }}>
      <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="#efefef" strokeWidth="2">
