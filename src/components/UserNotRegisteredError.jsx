...
export default function UserNotRegisteredError() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4" style={{ background: "#F3F6F2" }}>
      <div className="max-w-sm w-full">
        ...
        <div className="rounded-2xl p-7 shadow-sm" style={{ background: "#FFFFFF", border: "1.5px solid #DCE6E1" }}>
          ...
          <p className="text-sm text-center mb-6" style={{ color: "#52615B" }}>
            Sua conta não está autorizada a usar o Consuobra. Entre em contato com o administrador para solicitar acesso.
          </p>
          <div className="rounded-xl p-4 mb-5 text-sm" style={{ background: "#F3F6F2", border: "1.5px solid #DCE6E1" }}>
            <p className="font-semibold mb-2" style={{ color: "#111917" }}>O que você pode fazer:</p>
            <ul className="space-y-1.5" style={{ color: "#52615B" }}>
              ...
              <li className="flex items-start gap-2"><span className="shrink-0">•</span>Entre em contato: <a href="mailto:suporte@consuobra.com.br" className="font-medium underline" style={{ color: "#123C34" }}>suporte@consuobra.com.br</a></li>
            </ul>
          </div>
          <button onClick={() => base44.auth.logout("/")} className="w-full h-11 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-colors" style={{ border: "1.5px solid #DCE6E1", color: "#52615B", background: "#FFFFFF" }}>
